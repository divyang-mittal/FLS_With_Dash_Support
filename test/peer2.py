...
def foo(PeerService):
    import rpyc
    from rpyc.utils.server import ThreadedServer
    t = ThreadedServer(PeerService, port=10062, protocol_config={                            # for each peer make changes here to set it's port
...
if __name__ == "__main__":
	port = 10062                                       # for each peer make changes here to set it's port
	quality = 5
	is_leader = False
	global connector_peer
	count_peer = 0
